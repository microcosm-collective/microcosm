...
func CleanWord(s string) string {
	...
	// TODO: return textPolicy.Sanitize(stripChars(s, true, false, false, true))
}

// CleanSentence strips all HTML tags, allows ASCII space
func CleanSentence(s string, preventShouting bool) string {
	return textPolicy.Sanitize(s)
	// TODO: return textPolicy.Sanitize(stripChars(s, true, true, false, preventShouting))
}
...
func CleanBlockText(s string) string {
	return textPolicy.Sanitize(s)
	// TODO: return textPolicy.Sanitize(stripChars(s, true, true, true, true))
}
